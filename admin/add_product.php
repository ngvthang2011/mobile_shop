<?php 
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql="INSERT INTO product(prd_name, prd_price, prd_warranty, prd_accessories, prd_promotion, prd_new, cat_id, prd_status, prd_details, prd_image, prd_featured)
              VALUES('$prd_name', $prd_price, '$prd_warranty', '$prd_accessories', '$prd_promotion', '$prd_new', $cat_id, $prd_status, '$prd_details', '$prd_image', $prd_featured)";
        $query=mysqli_query($connect,$sql);
