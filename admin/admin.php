...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li <?php if(isset($_GET['page_layout'])){if($_GET['page_layout']=='user'){echo 'class="active"';}} ?>><a href="index.php?page_layout=user"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg>Quản lý thành viên</a></li>
			<li <?php if(isset($_GET['page_layout'])){if($_GET['page_layout']=='category'){echo 'class="active"';}} ?>><a href="index.php?page_layout=category"><svg class="glyph stroked open folder"><use xlink:href="#stroked-open-folder"/></svg>Quản lý danh mục</a></li>
			<li <?php if(isset($_GET['page_layout'])){if($_GET['page_layout']=='product'){echo 'class="active"';}} ?>><a href="index.php?page_layout=product"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg>Quản lý sản phẩm</a></li>
